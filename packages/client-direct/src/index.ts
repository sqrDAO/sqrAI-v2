...
import { calendarApiRouter } from "@sqrdao/plugin-calendar";
import { repoApiRouter } from "@sqrdao/plugin-github";
        ...
        this.app.get(
            ...
            async (req: express.Request, res: express.Response) => {
                ...
                const roomId = stringToUuid(
                    req.query.roomId.toString() ?? "default-room-" + agentId
                );
                ...
                const result = await runtime.messageManager.getMemories({
                    roomId,
